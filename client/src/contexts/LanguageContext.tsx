...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'exec.positioning': 'Ayudo a empresas fintech y adquirentes a abrir mercado, construir alianzas estratégicas y convertir relaciones B2B en volumen transaccional medible.',
    'exec.targetRoles.title': 'ROLES OBJETIVO & ESPECIALIZACIÓN',
    'exec.contracting.title': 'CONDICIONES DE CONTRATACIÓN',
    'exec.location.label': 'Ubicación',
    'exec.location.val': 'México / LATAM',
    'exec.workMode.label': 'Modalidad',
    'exec.workMode.val': 'Remoto · Híbrido · Presencial',
    'exec.status.label': 'Disponibilidad',
    'exec.status.val': 'Inmediata',
  ...
  en: {
    ...
    'exec.positioning': 'I help fintech and acquiring companies expand market share, build strategic partnerships, and convert B2B relationships into measurable transaction volume.',
    'exec.targetRoles.title': 'TARGET ROLES & SPECIALIZATION',
    'exec.contracting.title': 'CONTRACTING CONDITIONS',
    'exec.location.label': 'Location',
    'exec.location.val': 'Mexico / LATAM',
    'exec.workMode.label': 'Work Mode',
    'exec.workMode.val': 'Remote · Hybrid · On-site',
    'exec.status.label': 'Availability',
    'exec.status.val': 'Immediate',
